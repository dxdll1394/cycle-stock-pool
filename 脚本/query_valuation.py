...
<style>
  * { box-sizing: border-box; }
  ...
  table { width: 100%; border-collapse: separate; border-spacing: 0; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin-bottom: 20px; font-size: 12px; }
  th { background: #1a1a2e; color: #fff; padding: 8px 5px; text-align: center; cursor: pointer; user-select: none; white-space: nowrap; position: sticky; top: 0; z-index: 10; }
  ...
  td { padding: 6px 5px; text-align: center; border-bottom: 1px solid #e0e0e0; white-space: nowrap; }
